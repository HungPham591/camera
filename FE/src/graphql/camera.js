...
export const createCamera = gql`
    mutation($camera_name:String,$camera_location:[Float],$camera_link:String,$camera_public:Boolean){
        createCamera(camera_name:$camera_name,camera_location:$camera_location,camera_link:$camera_link,camera_public:$camera_public){
            _id
            camera_name
            camera_link
            camera_location
